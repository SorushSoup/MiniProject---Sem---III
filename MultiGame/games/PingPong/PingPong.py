...
# Sound
hit_sound = pygame.mixer.Sound("games/PingPong/hit.wav")
#score_sound = pygame.mixer.Sound("games/PingPong/score.wav")
...
def main_menu():
    while True:
        screen.fill(BLACK)  # Fill screen with black (no background image)
...
def game_loop():
    ...
    while True:
        ...
        # Draw everything
        screen.fill(BLACK)  # No background, just fill the screen with black
